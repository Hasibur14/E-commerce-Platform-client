...
const Contact = () => {
    return (
        <div className="container mx-auto mt-16">
            <Helmet>
                <title>Contact || PrimePick</title>
            </Helmet>
            <div className="bg-white dark:bg-gray-900">
                <div className="container px-6 py-12 mx-auto">
                    <div>
                        <p className="font-medium text-orange-500 dark:text-blue-400">Contact us</p>
                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
                        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                            <div>
                                ...
                                <p className="mt-2 text-sm text-orange-500 dark:text-blue-400">primepick@gmail.com</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-orange-500 dark:text-blue-400">Mirpur , Dhaka</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-orange-500 dark:text-blue-400">+1 (555) 000-0000</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden rounded-lg lg:col-span-2 h-96 lg:h-auto">
                            <iframe
                                ...
                                marginWidth="0"
                                scrolling="no"
                                src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=Mirpur,%20Dhaka,%20Bangladesh&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed">
                            </iframe>
                        </div>
                    </div>
                </div>
