                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
                        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                            <div>
                                ...
                                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">primepick@gmail.com</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Mirpur , Dhaka</p>
                            </div>
